...
install -m644 installer.conf %{buildroot}/etc/installer.conf
...
install -m644 static/images/ui-bg_highlight-soft_100_eeeeee_1x100.png %{buildroot}/work/installer/html/static/images/ui-bg_highlight-soft_100_eeeeee_1x100.pn
...
install -m644 static/images/ui-bg_diagonals-thick_18_b81900_40x40.png %{buildroot}/work/installer/html/static/images/ui-bg_diagonals-thick_18_b81900_40x40.pn
...
%attr(0644,root,root) /etc/installer.conf
%attr(0644,root,root) /etc/nginx/conf.d/installer.conf
%attr(0644,root,root) /usr/share/installer/installer.sql
%attr(0644,root,root) /work/installer/app/*
%attr(0644,root,root) /work/installer/html/static/*
